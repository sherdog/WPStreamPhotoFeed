...
class PhotoStreamFeed {
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( dirname ( __FILE__ ) ) . 'includes/IPhotoStreamFeedModule.php';
		
		require_once plugin_dir_path( dirname ( __FILE__ ) ) . 'includes/PhotoStreamFeed_Module.php';
		
		require_once plugin_dir_path( dirname ( __FILE__ ) ) . 'includes/PhotoStreamFeed_Template.php';
		
		require_once plugin_dir_path( dirname ( __FILE__ ) ) . 'includes/PhotoStreamFeed_Html_Helper.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new PhotoStreamFeedAdmin( $this->loader, $this->get_plugin_name(), $this->get_version() );
	}
