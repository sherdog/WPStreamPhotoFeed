 ...
 * @subpackage PhotoStreamFeed/admin
 */
...
class PhotoStreamFeedAdmin {
	...
	*/
	...
	public function __construct( $loader, $plugin_name, $version ) {
		...
		$this->loader->add_action( 'admin_menu', $this, 'instantiate', 1);
	...
	public function enqueue_styles() {
		 ...
		 * defined in PhotoStreamFeedLoader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The PhotoStreamFeedLoader will then create the relationship
